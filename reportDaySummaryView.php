        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header with-border">
              <h4 class="bordercool">1. รายงานการขายสินค้าประจำวัน(สรุป) <?php echo $salesDate;?></h4>
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  ...
                  $q = "SELECT sales_channel.sale_channel, COUNT(sales.sales_id) as sales_count, SUM(sales.sub_total) as sub, 
                  SUM(sales.vat)as vat, SUM(sales.grand_total) as total, sales.username 
                  FROM sales INNER 
                  JOIN sales_channel ON (sales.sale_channel_id = sales_channel.sale_channel_id) WHERE sales.sales_date = '$salesDate' 
                  GROUP BY sales.sale_channel_id 
                  ORDER BY sales_channel.sale_channel_id";
                  ...
                  <?php } ?>
                  <tr>
                    <td colspan="2" align="center"><span class="label label-warning" style="font-size:18px;"><b>- รวมยอดขายประจำวัน -</b></td>
