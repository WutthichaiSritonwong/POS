        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header with-border">
              <h4 class="bordercool">2. รายงานการขายสินค้าประจำวัน(รายละเอียด) <?php echo $salesDate;?></h4>
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  ...
                  $q = "SELECT sales_channel.sale_channel, customers.cust_name, customers.cust_phone, sales.ref_docinv, sales.sub_total, 
                  sales.vat, sales.grand_total, sales.username 
                  FROM sales 
                  ...
                  WHERE sales.sales_date = '$salesDate' 
                  ...
                  $sumFinal += $row['grand_total'];
                  $sumFFinal = number_format($sumFinal,2);
                  $username = $row['username'];
                  ?>
                  <tr>
                    <td align="center"><b><?php echo $ref_docinv;?></b></td>
                    <td align="center"><span class="badge bg-blue"><?php echo $sale_channel;?></span></td>
                    <td align="left"><b><?php echo $custName;?></b></td>
                    <td align="center"><b><?php echo $custPhone;?></b></td>
                  ...
                  <?php } ?>
                  <tr>
                    <td colspan="4" align="center"><span class="label label-warning" style="font-size:18px;"><b>- รวมยอดขายประจำวัน -</b></td>
