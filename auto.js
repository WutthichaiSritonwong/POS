...
$(".addmore").on('click',function(){
	...
	html += '<td><input type="number" name="price[]" id="price_'+i+'" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" disabled></td>';
	...
	html += '<td><input type="number" name="total[]" id="total_'+i+'" class="form-control totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" disabled></td>';
	html += '</tr>';
	$('table').append(html);
	i++;
});
...
function calculateAmountDue(){
	...
	if(amountPaid != '' && typeof(amountPaid) != "undefined" ){
		...
		amountDue = parseFloat( amountPaid ) - parseFloat(total);
		//$('.amountDue').val( amountDue.toFixed(2) );
		$('.amountDue').val( amountDue.toFixed(2) );
	} else {
		total = parseFloat(total).toFixed(2);
		$('.amountDue').val(addCommas( total));
	}
