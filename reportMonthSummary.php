...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="reportMonthSummaryView.php" method="post" target="_blank">
        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header with-border">
              <h4 class="bordercool">3. รายงานการขายสินค้าประจำเดือน</h4>
        	<div class="col-md-2"><br />
        	<div class="row"><h4>กรุณาระบุช่วงวันที่</h4>
          
              <div class="input-group input-group-md">
                <input input type="text" name="startDate" id="startDate" class="form-control" 
                placeholder="วันที่ / เดือน / ปี" required="" autocomplete="off">
              </div><br />
              <div class="input-group input-group-md">
                <input input type="text" name="endDate" id="endDate" class="form-control" 
                placeholder="วันที่ / เดือน / ปี" required="" autocomplete="off">
              </div>
              <br />
