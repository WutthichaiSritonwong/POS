...
<head>
  ...
  <title>ระบบสินค้าคงคลัง | MrG Soft</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>ระบบสินค้าคงคลังและซื้อขาย  <small>Version 1.0</small></h1>
      <ol class="breadcrumb">
	...
	<div class="box">
			...
			<table id="manageCategoriesTable" class="table table-bordered table-striped">
                    <thead>
                        <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer removeCategoriesFooter">
        <button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> ปิด</button>
        <button type="button" class="btn btn-primary" id="removeCategoriesBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> ลบ</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
